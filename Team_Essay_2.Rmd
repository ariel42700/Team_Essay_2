...
---
## Introduction
In this essay, our team will perform the process of forecasting height model based on several explanatory variables. The goal of this essay is to model the predicted height based on weight, FGP, FTP and PPG of a basketball team. To find the best model for predicted height, we need to find the model coefficients that minimize the sum of squared errors between the predicted height and the actual height.
